 ...
 */
class AliAppPayNotify extends AliPayPay implements PayNotify
{
    protected $params  = [];
    ...
    public function notify()
    {
        ...
        // 校验签名
        try {
            self::checkRsaSign(self::createSignTemp($this->params, 'sign,sign_type'), $this->params['sign'], $this->rsaPublicPath, 'PUBLIC', strtoupper($this->params['sign_type']) == 'RSA2');
        } catch (Throwable $e) {
